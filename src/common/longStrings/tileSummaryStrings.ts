...
// REVEALED MESSAGE
export const notRevealed = "This tile has yet to be revealed by the Topman. Should it become revealed, details about what lies here will be given to the players.";

// VESSEL MESSAGES
export const tileHasYonkadingo = "Your vessel, the mighty Yonkadingo, resides on this tile.  You are subject to the weather effects of this tile until your Helmsman makes their move to their next tile.";
export const tileHasAI = "The scourge you wish to defeat resides on this tile!";

// RESOURCE MESSAGE
export const getResourceMessage = (resourceType: ResourceTypes, resourceCount: number): string => {
    return resourceCount === 0 ?
        "Neither food nor pellets will be gathered if the Helmsman passes through this tile."
        : `If the helmsman passes over this tile while steering, they will ${resourceCount > 0 ? `gain ${resourceCount}`: `lose ${Math.abs(resourceCount)}`} ${ResourceTypes[resourceType]}`;
}

// MINE MESSAGES
export const tileHasMine = "Either your gunner has laid a mine here or the last time you checked this tile it had a mine.  If your Helmsman steers you over a mine, your Yonkadingo will take damage!"
    + " Keep in mind, if the enemy ran into this mine after the tile was revealed, the tile may not have a mine anymore.";
export const tileHasNoMine = "The last time you checked, this tile had no mine and your Yonkadingo could travel over it without taking damage."
    + " Keep in mind, this is the state of the tile when it was last revealed by the Topman.  If the enemy placed a mine after the Topman revealed this tile, it may now contain a mine.";

// WEATHER MESSAGES
export const weatherDescriptions = [
    "",
    "",
    "💨 Tailwind: A strong tailwind propels your Yonkadingo forward. A Helmsman that starts here can move an extra tile on their turn.",
    "🐌 Headwind: A strong headwind buffets your Yonkadingo.  A Helmsman that starts here can move one fewer tile on their turn.",
    ...
    "👿 Scary Monsters: Dark shadows loom in the depths below these waters.  The Yonkadingo shows fear if you steer it towards these waters. Any vessel that ends its turn on this tile takes slight damage."
];